    ...
    \resumeSubheading
	  ...
	  \resumeItemListStart
		\resumeItem{Vessel management system for field workers - Jurong Port, Singapore}
		  {Project on-going. Developed in Microsoft messaging platform using Kaizala with the backend developed in .NET core as a Web API, which integrates the front-end Kaizala actions with JPonline.}
	  \resumeItemListEnd
    \resumeSubheading
      {}{}
	  ...
	  \resumeItemListStart
	    \resumeItem{Azure Governance tool}
		  {Involved in the architecture and development of a .NET Core API project hosted on Azure Service Fabric and a supporting Bot, hosted on Azure Bot framework. The tool relies on Azure ARM REST APIs to help enterprises to adopt to Microsoft CAF (Cloud Adoption Framework) and better understand the spend on Azure cloud resources and helps to reduce unnecessary costs by deploying resources via Azure Blueprints and workflow.}
	  \resumeItemListEnd
    \resumeSubheading
	  {}{}
